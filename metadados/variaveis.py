...
msg_ajuda = "**.ola** | **.oi** | **.iai** | **.athena** : Mande um ola caloroso para mim, e responderei!\n" \
            ...
            "**.stalk** : Envio algumas informações suas... Anda stalkeando você mesmo rapaz!?.\n" \
            ...
            "**.log** MEMBRO LIMITE: Faço um pequeno histórico escolar de um membro especifico. " \
            "Ou o seu, caso não for especificado. Por padrão o limite é 10.\n" \
